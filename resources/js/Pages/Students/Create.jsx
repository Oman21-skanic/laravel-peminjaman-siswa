...
export default function Create({ auth, errors: serverErrors }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        email: '',
        alamat: '',
        is_active: true, // Tetap sebagai boolean
    ...
    const handleSubmit = (e) => {
        ...
        formData.append('is_active', data.is_active ? 1 : 0); // Konversi ke 1/0 untuk PHP
    ...
    // Gabungkan errors dari server dan client
    const allErrors = { ...serverErrors, ...errors };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Tambah Siswa Baru</h2>}
        >
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <header className="mb-6 sm:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">Tambahkan data siswa baru ke sistem</p>
                    </div>
                    <Link 
                    ...
                    <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-6">
                        ...
                        <div className="flex flex-col items-center sm:items-start sm:flex-row gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-500 mt-2">
                                    {data.is_active 
                                        ? 'Siswa akan aktif dalam sistem' 
                                        : 'Siswa akan tidak aktif dalam sistem'
                                    }
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div className="sm:col-span-1">
                                ...
                                />
                                {allErrors.nisn && (
                                    <p className="text-red-500 text-xs mt-1">{allErrors.nisn}</p>
                                )}
                            </div>
                            ...
                            <div className="sm:col-span-1">
                                ...
                                {allErrors.kelas && (
                                    <p className="text-red-500 text-xs mt-1">{allErrors.kelas}</p>
                                )}
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-end pt-6 border-t border-gray-200">
                            ...
                            >
                                ...
                                {processing ? 'Menyimpan...' : 'Tambah Siswa'}
                            </button>
                        </div>
                    </form>
                </section>
