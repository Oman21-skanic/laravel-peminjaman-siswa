...
export default function Edit({ auth, teacher, errors: serverErrors }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        profile_picture: null, // Tetap null, tidak perlu kirim jika tidak diubah
    });
    ...
    const handleSubmit = (e) => {
        ...
        // Hanya tambahkan profile_picture jika ada file baru
        ...
        put(route('teachers.update', teacher.id), {
            data: submitData,
            forceFormData: !!data.profile_picture, // Hanya forceFormData jika ada file
            onError: (errors) => {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Edit Guru</h2>}
        >
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <header className="mb-6 sm:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">Ubah informasi guru</p>
                    </div>
                    <Link 
                        ...
                        <div className="flex flex-col items-center sm:items-start sm:flex-row gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-500 mt-2">
                                    {data.is_active 
                                        ? 'Guru saat ini aktif dalam sistem' 
                                        : 'Guru saat ini tidak aktif dalam sistem'
                                    }
                                </p>
                            </div>
                        </div>
