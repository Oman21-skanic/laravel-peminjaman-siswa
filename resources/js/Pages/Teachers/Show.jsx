...
export default function Show({ auth, teacher }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Detail Guru</h2>}
        >
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <header className="mb-6 sm:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">Informasi lengkap tentang guru</p>
                    </div>
                    <div className="flex gap-3 w-full sm:w-auto">
                        ...
                        >
                            ...
                            <span className="hidden sm:block">Edit Guru</span>
                        </Link>
                    </div>
                </header>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="text-center lg:text-left">
                                ...
                                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mt-4">{teacher.nama_lengkap}</h2>
                                <p className="text-gray-600">{teacher.nip}</p>
                                <p className="text-blue-600 font-medium mt-1">{teacher.jabatan}</p>
                            ...
                            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-gray-900 bg-gray-50 p-3 rounded-lg border border-gray-200">
                                            {new Date(teacher.updated_at).toLocaleDateString('id-ID', {
                                                weekday: 'long',
                                                year: 'numeric',
                                                month: 'long',
                                                day: 'numeric'
