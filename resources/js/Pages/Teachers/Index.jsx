...
export default function Index({ auth, teachers, filters = {}, perPage = 10 }) {
    ...
    const columns = [
        ...
        },
        {
            key: 'nip',
            header: 'NIP',
            render: (teacher) => <span className="font-mono">{teacher.nip}</span>
        },
        {
            key: 'nama_lengkap',
            header: 'Nama Lengkap',
            render: (teacher) => <span className="font-medium text-gray-900">{teacher.nama_lengkap}</span>,
            mobileSpan: true
        },
        {
            key: 'jabatan',
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-4">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
                            ...
                            <SelectFilter
                                ...
                                options={uniqueJabatans.map(jabatan => ({ value: jabatan, label: jabatan }))}
