    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-gray-800/30 rounded-xl p-4 border border-gray-700/30">
                <h3 className="text-lg font-semibold text-white mb-4">Filter Data Guru</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-blue-500/20 rounded-xl p-4 border border-blue-500/30 text-center">
                    ...
                    <div className="text-sm text-gray-400">Total Guru</div>
                </div>
            ...
            <div className="bg-gray-800/30 rounded-xl border border-gray-700/30 overflow-hidden">
                <div className="p-4 border-b border-gray-700/50">
                    <h3 className="text-lg font-semibold text-white">
                        Data Guru ({teachers.length} records)
                    </h3>
                </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-gray-700/50 bg-gray-700/30">
                                ...
                                <th className="p-3 font-medium text-gray-400 text-sm uppercase tracking-wider">NIP</th>
                                <th className="p-3 font-medium text-gray-400 text-sm uppercase tracking-wider">Nama Lengkap</th>
                                <th className="p-3 font-medium text-gray-400 text-sm uppercase tracking-wider">Jabatan</th>
                            ...
                            {teachers.length === 0 ? (
                                <tr>
                                    <td colSpan="7" className="p-6 text-center text-gray-400">
                                        Tidak ada data guru untuk filter yang dipilih.
                                    </td>
                                </tr>
                            ) : (
                                teachers.map((teacher, index) => (
                                    <tr key={teacher.id} className="border-b border-gray-700/30 hover:bg-gray-700/20">
